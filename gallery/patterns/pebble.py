...
Usage:
    python gallery/patterns/pebble.py gallery/shapes/CurvyLamp.stl
    python gallery/patterns/pebble.py gallery/shapes/CurvyLamp.stl --export-artifacts
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Apply a pebble perforation pattern to a mesh.",
    )
    parser.add_argument(
        "mesh",
        type=Path,
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Also export Voronoi, shrunk tessellation, and pebble cutter preview "
            "debug views (GLB + STL) using the exact same seed data as the cut"
        ),
    )
    parser.add_argument(
        "--seed",
